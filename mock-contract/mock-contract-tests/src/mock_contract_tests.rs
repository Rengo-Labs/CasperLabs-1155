...
//     let instance = MOCKCONTRACTInstance::contract_instance(instance);
//     let proxy = MOCKCONTRACTInstance::contract_instance(proxy);
//     let to: Key = Key::Account(owner);
...
//             "hash-0000000000000000000000000000000000000000000000020000000000000000",
//         )
//         .unwrap(),
//         token_id,
//     );
//     proxy.balance_of(owner, Key::Account(owner));
//     let result: U256 = proxy.result();
//     assert_eq!(result, 1.into());
//     proxy.get_approved(owner, token_id);
//     let result_1: Key = proxy.result();
//     assert_eq!(
//         result_1,
//         Key::from_formatted_str(
//             "hash-0000000000000000000000000000000000000000000000020000000000000000",
